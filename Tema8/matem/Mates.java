...
public class Mates {
   ...
   * @return verdadero si el número que se pasa como parámetro es capicúa y falso
   *         en caso contrario
   */
   ...
   * en caso contrario.
   * <p>
   * Un número primo es un número natural mayor que 1 y divisible únicamente entre
   * el mismo y entre 1.
   *
   * @param x número del que se quiere saber si es primo
   * @return verdadero si el número que se pasa como parámetro es primo y falso en
   *         caso contrario
   */
   ...
   * @return dígito que está en la posición n del número <code>x</code> empezando
   *         a contar por el 0 y de izquierda a derecha
   */
