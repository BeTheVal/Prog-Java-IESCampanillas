...
public class ArrayBi {
	 ...
	 * <p>
	 * Por ejemplo, <code>generaArrayBiInt(8, 7, 10, 30)</code> devolvería un array
	 * de 8 filas por 7 columnas relleno con números generados al azar comprendidos
	 * entre 10 y 30.
	 * 
	 ...
	 * @return array bidimensional de números enteros rellena con valores aleatorios
	 ...
	 * ocurrencia de un número dentro de un array bidimensional. Si el número no se
	 * encuentra en el array, la función devuelve -1.
	 * 
	 * @param x array bidimiensional de números enteros
	...
	/**
	 * Dice si un número que se encuentra en una posición determinada de una matriz
	 * (un array bidimensional) que se pasa como parámetro es o no punto de silla.
	 * <p>
	 * El punto de silla cumple la condición de ser el mínimo en su fila y máximo en
	 * su columna.
	 * 
	 * @param x array bidimiensional de números enteros
	 ...
	 *          </code> y la columna <code>j</code> es el mínimo en su fila y el
	 ...
	 *                  diagonales se devolverá; la cadena <code>
	 ...
	 *                  </code> y <code>columna</code> y una dirección determinada
	 *         por el parámetro <code>direccion
	 *                  </code>
	 */
